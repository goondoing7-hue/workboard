...
self.addEventListener("fetch", (e) => {
  ...
  if (e.request.mode === "navigate") {
    e.respondWith((async () => {
      ...
      const isPerformance = url.pathname === new URL("./performance.html", self.location.href).pathname;
      const fallback = isAssessment ? "./adhd.html" : isPerformance ? "./performance.html" : "./index.html";
